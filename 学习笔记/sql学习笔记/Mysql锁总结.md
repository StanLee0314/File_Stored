...
![img](http://mmbiz.qpic.cn/mmbiz_png/B4NbFWic0yX2Ga6GAC1U35Ms3qFIpEFyLXRdlsGh3qsicHeAibxnmSlmkg2gKjeLVfdemoIyJftnb5jbpHsZ5aicxw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](http://mmbiz.qpic.cn/mmbiz_png/B4NbFWic0yX2Ga6GAC1U35Ms3qFIpEFyL6DrT1avsL39FUHrS3bmEkBPEJESK7gXaoK7kSgwPWMhl7ylSqhtGJQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](http://mmbiz.qpic.cn/mmbiz_png/B4NbFWic0yX2Ga6GAC1U35Ms3qFIpEFyLF4UeycprbhLsPUUibk0l8hDZVibibtGt84PKSuIlBLibqlcXnpHCnBIHbg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
- 只有执行计划真正使用了索引，才能使用行锁：即便在条件中使用了索引字段，但是否使用索引来检索数据是由 MySQL 通过判断不同执行计划的代价来决定的，如果 MySQL 认为全表扫描效率更高，比如对一些很小的表，它就不会使用索引，这种情况下 InnoDB 将使用表锁，而不是行锁。因此，在分析锁冲突时， 别忘了检查 SQL 的执行计划（可以通过 explain 检查 SQL 的执行计划），以确认是否真正使用了索引。（更多阅读：[MySQL索引总结](http://mp.weixin.qq.com/s?__biz=MzI3NzM2OTQ5Mg==&mid=2247484163&idx=1&sn=4014aedceaebc6b67523afe37c8bfa12&chksm=eb6604f8dc118dee83875edd5da5d32c43e573976d41e96568987bdcdc078634fce142ef5c95&scene=21#wechat_redirect)）
...
![img](http://mmbiz.qpic.cn/mmbiz_png/B4NbFWic0yX2Ga6GAC1U35Ms3qFIpEFyLYFLdMRKryicOgTE2YWsXNWZyjNxMg20I2xNaSojF5WNlEeuZuWDP1Aw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

![img](http://mmbiz.qpic.cn/mmbiz_png/B4NbFWic0yX2Ga6GAC1U35Ms3qFIpEFyLhk3C0xyOmtu1MSiaUGNWmGb4azcGjHZObOkZRA4Mia5T9vpAibG4HrHkw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](http://mmbiz.qpic.cn/mmbiz_png/B4NbFWic0yX2Ga6GAC1U35Ms3qFIpEFyLRWEpeNHCJg4GuoVXqKBcBiaMVnJl4Vb1Jgkcaep6sImKWmw1zGiah5cQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

#### **LOCK TABLES 和 UN\**LOCK TABLES\****
...
![img](http://mmbiz.qpic.cn/mmbiz_png/B4NbFWic0yX2Ga6GAC1U35Ms3qFIpEFyLic6PHeV4yUC00ggCXia2l2ppFdkxTHFXqK54SW9nlomaFYQLW0ZW7Ngg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](http://mmbiz.qpic.cn/mmbiz_png/B4NbFWic0yX2Ga6GAC1U35Ms3qFIpEFyLRSkPjlu4c10Lpraty6efh6tR5uoIyibibcmzoYDEYSg1H97pPicNicZlibw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)



这时，如果不先给两个表加锁，就可能产生错误的结果，因为第一条语句执行过程中， order_detail 表可能已经发生了改变。因此，正确的方法应该是： 

![img](http://mmbiz.qpic.cn/mmbiz_png/B4NbFWic0yX2Ga6GAC1U35Ms3qFIpEFyLxP7VOYxmLAo1DM9fhX7x4V0kyIxExDGYXxGgSOvTVhzQhDBCvNOGKQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
